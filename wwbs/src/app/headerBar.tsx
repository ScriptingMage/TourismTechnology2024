  ...
  return (
    <header className="bg-white shadow border-b-2">
      <div className="mx-auto max-w-7xl h-20 px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <div className="flex gap-4">
          <a href="/hiking-trails" className="hover:bg-gray-200 rounded-lg p-2">
            User Showcase
          </a>
          <a href="/admin" className="hover:bg-gray-200 rounded-lg p-2">
            Admin showcase
          </a>
          <a href="/technicals" className="hover:bg-gray-200 rounded-lg p-2">
            Technicals
          </a>
        </div>
      </div>
